      ...
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2">
                ...
                {visibleLoginLinks.map((link) => {
                  ...
                  return (
                    <NavLink
                      key={link.path}
                      to={link.path}
                      className="flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-medium transition hover:bg-[var(--app-panel-strong)] hover:text-[var(--app-text)]"
          ...
          <button
            ...
            className="grid h-10 w-10 place-items-center rounded-full bg-white/5 text-slate-200 transition hover:bg-white/10 hover:text-white md:hidden"
        ...
        >
          <div className="flex flex-col gap-2 pt-3">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <ThemeToggle themeMode={themeMode} onThemeChange={setThemeMode} compact />
              </div>
            </div>
            ...
            {visibleLoginLinks.map((link) => {
              ...
              return (
                <NavLink
                  key={link.path}
                  to={link.path}
                  className="flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium transition hover:bg-(--app-panel-strong) hover:text-[var(--app-text)]"
                  style={{
                    backgroundColor: "var(--app-panel)",
